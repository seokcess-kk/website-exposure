...
**현재 milestone (2026-05-27)**: 사용자 7항목 + (a)(b)(c) plan 3종 v1.0 acceptance + **Option A — 운영자 일상 단순화** 합류. 최신 cycle: **ADMIN_SIMPLIFY (Option A)** (2026-05-27) — "기능 완성도 우선, 운영 부담 후순위" 진단 후 refactor. (a) 대시보드 최상단 "오늘 할 일" 카드 신규 (`selectTodayActions` improvement-queue 5 카테고리 top 3 · count desc + priority 동률 fallback) (b) 운영 현황 8 → 5 카드 (UnlinkedEvidence·Stale·LowReadinessPublished 3 카드 제거 — 모두 오늘 할 일 + improvement-queue deep link 안 중복) (c) NavMenu 14 항목 3 그룹화 (운영 일상 4 · 콘텐츠 7 · 정보 setup 2) + separator + tier 별 색 강약. 7 vitest PASS · 누계 251 PASS. 직전: CAI v1.1 LlmUsageCard. 잔여 = NSA v1.x (OpenAPI · gap 분석) + CAI/CCAL/MTL/NPL-DEFER 다수.
